...
connectUtil.createRoutesHandler = (context) => {
...
connectUtil.createErrorCastMiddleware = () => {
  const oidcRouter = Router();
...
connectUtil.createLoginHandler = (context) => {
  ...
  return function (req, res, next) {
    const { viewHandler } = context.options.routes.login;
